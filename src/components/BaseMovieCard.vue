<template>
  <div
    ref="movieRef"
    class="movie-card-container overlay overflow-hidden min-w-[300px] w-full h-[200px] rounded-md border-2 border-white relative cursor-pointer hover:border-[#17e444] ease-in-out duration-300 hover:scale-105"
  >
    <img
    ...
    />
    <div
      class="movie-card-info absolute -bottom-32 z-10 p-3 w-full bg-[#050505de] rounded-b-md"
    >
